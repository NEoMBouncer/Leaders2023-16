        ...
        >
          <div class="sm:col-span-6">
            ...
            <div class="relative">
              ...
              />
              <span v-if="errors.username" class="text-red-600 text-sm">Заполните поле "E-Mail"</span>
            </div>
          </div>
          <div class="sm:col-span-6">
          ...
          <div class="sm:col-span-6">
            ...
            <div class="relative">
              <Field
                  ...
                  :class="errors.password ? 'border-red-600 focus:border-red-600' : ''"
              />
              <span v-if="errors.password" class="text-red-600 text-sm">Пароли не совпадают</span>
            </div>
          </div>
