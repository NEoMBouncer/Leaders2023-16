...
import { UsersIcon, BriefcaseIcon, ChartPieIcon, BellIcon } from '@heroicons/vue/24/outline'
...
export default {
  ...
  components: {
    ...
    Loading,
    ArrowDownIcon, ArrowUpIcon, UsersIcon, BriefcaseIcon, ChartPieIcon, BellIcon
  },
  data() {
    return {
      loading: false,
      stats: [
        { name: 'Стажировки', href: '/cabinet/applications-organization', icon: UsersIcon, stat: '4 шт', change: '2', changeType: 'increase' },
        { name: 'Школа наставников', href: '/cabinet/school-organization', icon: BriefcaseIcon, stat: '5 всего', change: '1', changeType: '' },
        { name: 'Рейтинг', href: '/cabinet/rating', icon: ChartPieIcon, stat: '4,49', change: '+0,44', changeType: 'increase' },
